...
/*==============================================================*/
double scrInteractor::getCoordenadaXClicada(){
	return valorX;
}

double scrInteractor::getCoordenadaYClicada(){
	return valorY;
	}

double scrInteractor::listenerClickMouseLeft(){
...
// static GLint my;
	...
	if (state == GLUT_DOWN)
	{
		...
		if (button == GLUT_LEFT_BUTTON)
		{
			...
			//adicionado por mim
			this->ScreenToPoint(this->pt_mouse, coordenadasClique);
			valorX= coordenadasClique[0];
			valorY= coordenadasClique[1];
			//-
